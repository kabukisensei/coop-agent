...
[ "$(coop_manifest_get extensions.pi-mcp-adapter)" = "2.34.0" ] && ok "coop_manifest_get extensions.pi-mcp-adapter" || ko "coop_manifest_get extensions.pi-mcp-adapter"
...
[ "$(coop_manifest_extension_spec pi-mcp-adapter)" = "npm:pi-mcp-adapter@2.34.0" ] && ok "literal extension spec: pi-mcp-adapter" || ko "extension spec mismatch"
